...
<body class="sidebar-mini layout-fixed" style="height: auto;">
    ...
    <script src="{{ asset('js/all-validation.js') }}"></script>
    <script>
        $(function() {
  ...
  $.fn.dataTable.ext.classes.sPageButton = '';
    ...
    <script>
        ...
        //             'current_avatar': document.querySelector('#current_avatar').value
        //         })
        //         .then((response) => {
        //             console.log('success')
        //             window.location.href = '{{ route("admin.profile", [$user->id]) }}'
        //         })
        //         .catch((error) => {
        ...
        //             // firstItemDOM.insertAdjacentHTML('afterend', `<span class="error invalid-feedback">${firstErrorMessage}</span>`)
        //         });
        //     });
